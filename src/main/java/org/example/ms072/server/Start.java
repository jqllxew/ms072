...
import org.example.ms072.server.events.MapleOxQuizFactory;
...
import org.example.ms072.tools.CustomPlayerRankings;
    ...
    public static void loadProperties() {
        ...
        try {
            InputStreamReader reader = new InputStreamReader(
                    Objects.requireNonNull(Start.class.getClassLoader().getResourceAsStream("ms072server.properties")),
