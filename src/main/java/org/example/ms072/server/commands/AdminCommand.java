...
import  org.example.ms072.custom.LoadPacket;
...
import  org.example.ms072.handling.login.handler.AutoRegister;
import  org.example.ms072.handling.world.CharacterTransfer;
import  org.example.ms072.handling.world.MapleMessengerCharacter;
import  org.example.ms072.handling.world.PlayerBuffStorage;
...
import org.example.ms072.server.ShutdownServer;
...
public class AdminCommand {
    ...
    public static class 最小属性 extends minstats {
    }
    
    public static class 满技能 extends maxSkills {
    }

    public static class 清技能 extends minSkills {
    }
        ...
        public int execute(MapleClient c, String splitted[]) {
            if (splitted.length > 2) {
                ...
                if (type == 1) {
                    ...
                    c.getPlayer().dropMessage(6, "用法: !给所有人点券 [点券类型1-2] [点卷数量][1是点卷.2是抵用卷]");
                    return 0;
                }
                if (quantity > 10000) {
                    quantity = 10000;
    ...
    public static class minstats extends CommandExecute {
        ...
        public int execute(MapleClient c, String splitted[]) {
            ...
            player.updateSingleStat(MapleStat.STR, (short) 4);
            player.updateSingleStat(MapleStat.DEX, (short) 4);
            player.updateSingleStat(MapleStat.INT, (short) 4);
            player.updateSingleStat(MapleStat.LUK, (short) 4);
