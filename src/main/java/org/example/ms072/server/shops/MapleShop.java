package org.example.ms072.server.shops;
...
//            if (c.getPlayer().isAdmin()) {
                c.getPlayer().dropMessage("您已建立与商店" + id + "的连接"+getNpcId());
//            }
        }
...
//                }
            ...
            c.sendPacket(CField.NPCPacket.confirmShopTransaction((byte) 0x8, this, c, -1));
        }
    }
