...
import org.example.ms072.custom.CustomSkills;
...
import org.example.ms072.server.buffs.BuffClassFetcher;
...
import org.example.ms072.tools.wztosql.CaltechEval;
...
//                        break;
    ...
    public final boolean applyTo(final MapleCharacter applyfrom, final MapleCharacter applyto, final boolean primary, final Point pos, int newDuration) {
        ...
        if (expinc != 0) {
            ...
            applyto.getClient().sendPacket(EffectPacket.showForeignEffect(0x0B));
            ...
            if (effectedOnEnemy > 0) {
                ...
                if (sourceid == 2910000 || sourceid == 2910001) { //red flag
                    applyto.getClient().sendPacket(EffectPacket.showOwnBuffEffect(sourceid, 11, applyto.getLevel(), level));
...
//        }
    ...
    public final void applyKaiser_Combo(MapleCharacter applyto, short combo) {
        ...
        applyto.getClient().sendPacket(BuffPacket.giveBuff(0, 99999, stat, this));
    }
    ...
    public final void applyComboBuff(MapleCharacter applyto, short combo) {
        ...
        applyto.getClient().sendPacket(BuffPacket.giveBuff(this.sourceid, 99999, stat, this));
    ...
    public final void applyLunarTideBuff(MapleCharacter applyto) {
        ...
        applyto.getClient().sendPacket(BuffPacket.giveBuff(this.sourceid, 99999999, stat, this));
    }
