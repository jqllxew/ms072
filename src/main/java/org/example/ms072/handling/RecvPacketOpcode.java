...
public enum RecvPacketOpcode implements WritableIntValueHolder {
    ...
    //使用箱子类
    USE_ITEM_BAOWU(true, (short) 0x6C),
    //悄悄话
    ...
    //打开校谱
    REQUEST_FAMILY(true, (short) 0x90),
    //打开学院
    OPEN_FAMILY(true, (short) 0x91),
    //学院操作
    FAMILY_OPERATION(true, (short) 0x92),
    //删除学员
    DELETE_JUNIOR(true, (short) 0x93),
    //删除老师
    DELETE_SENIOR(true, (short) 0x94),
    //接受学院邀请
    ACCEPT_FAMILY(true, (short) 0x95),
    //使用名声度
    USE_FAMILY(true, (short) 0x96),
    //学院公告
    FAMILY_PRECEPT(true, (short) 0x97),
    //学院召唤同学
    FAMILY_SUMMON(true, (short) 0x98),
    //学院移动到同学身边
    CYGNUS_SUMMON(true, (short) 0x99),
    //宠物移动
    ...
    REWARD_ITEM(true, (short) 0x999),//F2
