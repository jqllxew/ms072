...
import  org.example.ms072.server.stores.MapleMiniGame;
import  org.example.ms072.server.stores.MaplePlayerShop;
...
//                    }
            ...
            case CLOSE_MERCHANT: {
                ...
                if (merchant != null && merchant.getShopType() == 1 && merchant.isOwner(chr) && merchant.isAvailable()) {
                    c.sendPacket(PlayerShopPacket.shopErrorMessage(0x12, 0));// 关闭窗口
                ...
                /*final IMaplePlayerShop merchant = chr.getPlayerShop();
                 ...
                 c.sendPacket(CWvsContext.broadcastMsg(1, "关闭商店出现未知错误."));
                 c.sendPacket(CWvsContext.enableActions());
                 }*/
 /*   final IMaplePlayerShop merchant = chr.getPlayerShop();
