...
import  org.example.ms072.scripting.EventScriptManager;
import  org.example.ms072.server.MapleSquad;
import  org.example.ms072.server.MapleSquad.MapleSquadType;
import  org.example.ms072.server.events.*;
import  org.example.ms072.server.life.PlayerNPC;
import  org.example.ms072.server.maps.AramiaFireWorks;
import  org.example.ms072.server.maps.MapleMapFactory;
...
public class ChannelServer {
    ...
    private int port = 2524;
    private static final int DEFAULT_PORT = ServerConfig.ChannelPort;
    public int channel, running_MerchantID = 0, flags = 0;
    ...
    public final void run_startup_configurations() {
        ...
        try {
            cashRate = ServerConfig.cashRate;
            traitRate = ServerConfig.traitRate;
            BossDropRate = ServerConfig.BossDropRate;
            ExpRate = ServerConfig.ExpRate;
            MesoRate = ServerConfig.MesoRate;
            DropRate = ServerConfig.DropRate;
            serverMessage = ServerConfig.serverMessage;
        ...
        try {
            ...
            System.out.println("频道服务器 (频道: " + getChannel() + ") 绑定端口：" + port + " 失败" + e);
        }
    }
    ...
    public final void shutdown() {
        ...
        broadcastPacket(CWvsContext.broadcastMsg(0, "服务器即将关闭维护."));
