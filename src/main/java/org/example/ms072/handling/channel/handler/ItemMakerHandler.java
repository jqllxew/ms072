...
import  org.example.ms072.client.SkillFactory.CraftingEntry;
...
import  org.example.ms072.server.ItemMakerFactory;
import  org.example.ms072.server.ItemMakerFactory.GemCreateEntry;
import  org.example.ms072.server.ItemMakerFactory.ItemMakerCreateEntry;
...
import  org.example.ms072.server.maps.MapleExtractor;
    ...
    public static void ProfessionInfo(final LittleEndianAccessor slea, final MapleClient c) { //so pointless
        try {
            ...
            if (skillid.startsWith("9200") || skillid.startsWith("9201")) {
                ...
                c.sendPacket(CWvsContext.updateSpecialStat(skillid, level1, level2, c.getPlayer().getHonourNextExp()));
                return;
