...
public class PartyHandler {
    ...
    public static final void DenyPartyRequest(LittleEndianAccessor slea, MapleClient c) {
        ...
        if (action == 23) {//30 == party join
            ...
            if (cfrom != null) {
                cfrom.getClient().sendPacket(CWvsContext.PartyPacket.partyStatusMessage(0x17, c.getPlayer().getName()));
            }
        }
                ...
                if (party == null) {
                    ...
                    if (party != null) {
                        ...
                        if ((party.getMembers().size() < 6) && (c.getPlayer().getQuestNoAdd(MapleQuest.getInstance(122901)) == null)) {
                            ...
                            c.sendPacket(CWvsContext.PartyPacket.partyStatusMessage(0x11, null));
                        }
                    } else {
                        c.sendPacket(CWvsContext.PartyPacket.partyStatusMessage(0x0D, null));
                    }
                } else {
                    c.sendPacket(CWvsContext.PartyPacket.partyStatusMessage(0x10, null));
                }
                break;
            case 4:
                if (party == null) {
                ...
                if (theCh > 0) {
                    ...
                    c.sendPacket(CWvsContext.PartyPacket.partyStatusMessage(0x13, null));
                }
                break;
            case 5://was5
    ...
    public static void MemberSearch(LittleEndianAccessor slea, MapleClient c) {
        ...
        c.sendPacket(CWvsContext.PartyPacket.showMemberSearch(c.getPlayer().getMap().getCharactersThreadsafe()));
    }
