 ...
 */
public class MS072 extends javax.swing.JFrame {

    private static final MS072 instance = new MS072();

    /**
     * Creates new form MS072
     */
    public static MS072 getInstance() {
        return instance;
    }
    ...
    public MS072() {
        ...
        setTitle("MS072-服务端后台管理工具 当前版本：072.1");
        initComponents();
    }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        try {
            ...
            Logger.getLogger(MS072.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            if (ts == null && (t == null || !t.isAlive())) {
                ...
                ts = EventTimer.getInstance().register(() -> {
                    ...
                    World.Broadcast.broadcastMessage(CWvsContext.serverNotice(0, "服务器将在 " + minutesLeft + "分钟后关闭. 请所有玩家立即下线."));;
                    ...
                    if (mch.getName().equals(名字)) {
                        if (数量 >= 0) {
                            ...
                            if (type.equals(MapleInventoryType.EQUIP) && !GameConstants.isThrowingStar(物品ID) && !GameConstants.isBullet(物品ID)
                                ...
                                MapleInventoryManipulator.addById(mch.getClient(), 物品ID, (short) 数量, "", null, 给予时间, false, "通过GM控制台获得");
                            }
                        } else {
                            MapleInventoryManipulator.removeById(mch.getClient(), GameConstants.getInventoryType(物品ID), 物品ID, -数量, true, false);
                        }
                        mch.getClient().sendPacket(InfoPacket.getShowItemGain(物品ID, (short) 数量, true));
                        输出A = "[刷物品]:" + 输出;
                    }
                }
            }
